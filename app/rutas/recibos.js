...
router.get('/filterByName/:name', VerifyToken, reciboController.getAllRecibosByName); //filtrar los recibos por nombres
 router.post('/', VerifyToken, corsMiddleware, reciboController.createRecibo); //crear un nuevo recibo
router.post('/payment/:id', VerifyToken, corsMiddleware, reciboController.payment); // abonar saldo de un recibo
